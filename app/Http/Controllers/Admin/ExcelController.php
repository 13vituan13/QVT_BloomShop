...
{   
    ...
    public function __construct(IOrder $orderRepo, IOrderDetail $orderDetailRepo)
    {
    ...
    public function exportBill(Request $request)
    {
        ...
        $res = $this->_orderRepo->getById($order_id);
        $order_detail = $this->_orderDetailRepo->getById($order_id);
